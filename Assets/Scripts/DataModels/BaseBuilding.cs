...

{
    ...
    public List<ProductionJob> activeProduction;
...
/// Production job (research, crafting, etc.)
...

{
    ...
    public string jobType;                      // "research", "craft", "training"

    public string itemId;                       // Item being produced/researched
